...
<div class="d-flex flex-row-reverse mybgColor">
  ...
  <c:when test="${sessionScope.sessionId == null }">
	  ...
	  <div class="p-2 bg-primary"><a href="${pageContext.request.contextPath}/member/memberForm" class="nav-link text-white" id="item3">회원가입</a></div>
  </c:when>
  <c:when test="${sessionScope.sessionId != null }">
	  ...
	  <div class="p-2 bg-primary"><a href="${pageContext.request.contextPath}/member/myPage" class="nav-link text-white" id="item3">MyPage</a></div>
	  <div class="p-2 bg-info"><a href="#" class="nav-link text-white" id="item1">장바구니</a></div>
	  <div class="p-2 bg-info"><a href="${pageContext.request.contextPath}/orders/ordersList" class="nav-link text-white" id="item1">구매목록</a></div>
	  <div class="p-2 bg-info"><a href="#" class="nav-link text-white" id="item1">내정보수정</a></div>
  </c:when>
  </c:choose>
    ...
    <nav class="navbar navbar-expand-sm mybgColor" >
     <div class="container-fluid" >
        <ul class="navbar-nav" >
            ...
            <li class="nav-item"><a href="${pageContext.request.contextPath}/item/itemList?gender=m" class="nav-link">남성의류</a></li>
            <li class="nav-item"><a href="${pageContext.request.contextPath}/item/itemList?gender=w" class="nav-link">여성의류</a></li>
            <li class="nav-item"><a href="${pageContext.request.contextPath}/item/categoryList" class="nav-link">잡화</a></li>

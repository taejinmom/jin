...
<div class="container mt-5">
	<div class="row">
		...
		<%--	<p><c:if test="${today != null}"> 오늘의 날짜 : ${today}</c:if></p>--%>
		</div>
		<div class="col">
...
<div class="tab-content" id="nav-tabContent">
  ...
  <table class="table mytable-condensed">
    <tbody>
      <tr>
        <td>회원가입</td>
        <td><a href="${pageContext.request.contextPath }/member/memberForm">click</a></td>
        <td>2022-06-21</td>
      </tr>
      <tr>
        <td>내정보</td>
        <td><a href="${pageContext.request.contextPath }/member/mypage">click</a></td>
        <td>2022-06-21</td>
      </tr>
      <tr>
        <td>상품 리스트</td>
        <td><a href="${pageContext.request.contextPath }/item/itemlist">click</a></td>
        <td>2022-06-21</td>
      </tr>
      <tr>
        <td>로그인</td>
        <td><a href="${pageContext.request.contextPath }/member/loginForm">click</a></td>
        <td>2022-06-21</td>
      </tr> 
      <tr>

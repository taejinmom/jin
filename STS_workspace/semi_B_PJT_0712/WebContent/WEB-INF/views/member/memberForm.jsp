...
<!-- pattern 속성을 이용한 정규표현식으로 데이터의 유효성 검사를 할 수 있다. -->
      <input type="text" class="form-control" id="mem_id"
       ...
       pattern=".{1,10}"><button type="button" class="btn btn-primary" id="btn1">중복확인</button>
   	 <div id="target"></div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="mem_jubun"
       placeholder="주민번호를 입력하세요" name="mem_jubun" required="required">
    </div>
    <div class="form-group">
      <label for="mem_phone">전화번호</label>
      <input type="text" class="form-control" id="mem_phone"
       placeholder="전화번호를 입력하세요" name="mem_phone" required="required">
    </div>
    <div class="form-group">
      <label for="mem_adr">주소</label>
      <input type="text" class="form-control" id="mem_adr"
       placeholder="주소를 입력하세요" name="mem_adr" required="required">
    </div>

	...
	<header class="text-white text-center">
		<div class="d-flex flex-row-reverse mybgColor">
			...
			<div class="p-2 bg-primary">
				<a href="#" class="nav-link text-white" id="item3">Flex item 3</a>
			</div>
		</div>
		<!-- Carousel -->
		<div id="demo" class="carousel slide" data-bs-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="resources/image/d1.jpg" alt="Kosmo113" class="d-block"
						style="width: 100%">
				...
				<div class="carousel-item">
					<img src="resources/image/d2.jpg" alt="Carousel" class="d-block"
						style="width: 100%">
					<div class="carousel-caption">
				...
				<div class="carousel-item">
					<img src="resources/image/d3.jpg" alt="JSP" class="d-block"
						style="width: 100%">
					<div class="carousel-caption">
						<h3>UI 요구사항 확인하기,UI 설계하기</h3>
						<p>jQuery 를 이용하여 제공받은 샘플파일에서 아래 요구사항대로 구현합니다.</p>

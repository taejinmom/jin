...
//	// <jsp:setProperty property="*" name="vo"/> 폼의 name과 vo의 property가 같으면 알아서 넣어줌
//	// 파라미터값을 Map으로 모두 받아서  BoardVO vo = new BoardVO(); 
...
//		// Spring MVC는 기본값이 forward인데 만약에 redirect 로 전송하기 위해서
//		// 아래처럼 redirect:요청값 

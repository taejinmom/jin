...
<!-- pattern 속성을 이용한 정규표현식으로 데이터의 유효성 검사를 할 수 있다. -->
      <input type="text" class="form-control" id="id"
       placeholder="아이디 입력(5-10)" name="id"
       maxlength="10" required="required"
       pattern=".{5,10}"><button type="button" class="btn btn-primary" id="btn1">중복확인</button>
   	 <div id="target"></div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input class="form-check-input" type="radio" name="gender" id="gender1" value="남자">남자 
      <label class="form-check-label" for="gender1"></label>
      </div>
      <div class="form-check">	
	  <input class="form-check-input" type="radio" name="gender" id="gender2" value="여자">여자 

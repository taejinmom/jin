							...
							function(idx) {
								console
										.log("바뀔 이미지 :" + imgArr[idx]
												...
												+ $(this).attr('src'));
								$(this).attr('src',
										'${pageContext.request.contextPath}/resources/image/' + imgArr[idx]);
							});
	...
	<header class="text-white text-center">
		<div class="d-flex flex-row-reverse mybgColor">
			...
			<div class="p-2 bg-warning">
				<a href="${pageContext.request.contextPath}/member/loginForm" class="nav-link text-white" id="item2">Login</a>
			</div>
